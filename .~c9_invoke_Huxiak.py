...
@login_required
        stock = [(userCurrent.symbol_name, userCurrent.noShares) for item in userCurrent.query.filter_by(user_id = current_user.id).order_by(userCurrent.symbol_name).all()]
